  ...
  return (
    ...
    <section className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%  text-white py-16">
      <div className="container mx-auto text-center">
        <h1 className="text-4xl font-bold mb-4">Welcome to Our Awesome Product</h1>
        <p className="text-lg mb-8">Solving your problems with ease!</p>
        <a href="#" className="bg-white text-blue-500 px-6 py-3 rounded-full hover:bg-blue-100">
          Get Started
        </a>
      </div>
    </section>
    ...
    <section className="bg-blue-800 text-white py-16">
      <div className="container mx-auto text-center">
        ...
        <a href="#" className="bg-white text-blue-800 px-6 py-3 rounded-full hover:bg-blue-100">
          Sign Up
        </a>
      </div>
    </section>
